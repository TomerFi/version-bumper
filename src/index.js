 ...
 * @param preset Conventional preset to use. Defaults to 'conventionalcommits'.
 * @returns {Promise<original: '2.1.4'|bump: 'major'|next: '3.0.0'|dev: '3.0.0-dev'>}
 */
module.exports = async function (source = 'git', path = './', bump = 'auto', label = '-dev', preset = 'conventionalcommits') {
